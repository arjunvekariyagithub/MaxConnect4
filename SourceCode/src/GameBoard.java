...
/**
 * This is the Gameboard class. It implements a two dimension array that represents a connect four gameboard. It keeps track of
 * the player making the next play based on the number of pieces on the game board. It provides all of the methods needed to
 * implement the playing of a max connect four game.
 * 
 * @author James Spargo
 * 
 */
